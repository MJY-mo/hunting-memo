...
async function showTrapPage() {
    ...
    app.innerHTML = `
        ...
        <div class="grid grid-cols-2 gap-3 mb-4">
            <div>
                <label for="filter-status" class="block text-sm font-medium text-gray-700">状態</label>
            ...
            <div>
                <label for="filter-type" class="block text-sm font-medium text-gray-700">種類</label>
...
async function showTrapEditForm(trapId) {
    ...
    app.innerHTML = `
        <form id="trap-form" class="space-y-4">
            ...
            <h3 class="text-lg font-semibold">位置情報</h3>
            <button type="button" id="get-location-btn" class="btn btn-secondary w-full">📍 現在地を取得</button>
            <p id="location-status" class="text-sm text-gray-500 text-center mt-2"></p>
